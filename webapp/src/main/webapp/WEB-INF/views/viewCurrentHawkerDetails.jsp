        ...
        <div class="content-section">
        	...
        	<div>
        		<form:form action="/customer/currentHawkers/${hawker.username}" method="POST" modelAttribute="dateForm">
        			...
        			<form:input path="customerUsername" hidden="true" value="${username}"/>
        			<form:input path="hawkerUsername" hidden="true" value="${hawker.username}"/>
  				...
  				<tbody>
    				...
    				<tr>
      				...
      				<div class="modal-footer">
        				...
        				<button type="button" class="btn btn-primary">Payment done!</button>
      				</div>
    				</div>
  				</div>
			</div>
