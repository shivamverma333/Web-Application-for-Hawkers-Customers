            ...
            <%} %>
        		...
        		<legend class="border-bottom mb-4">Register</legend>
                	...
                	<div class="form-group">
                    	...
                    	<c:choose>
        					<c:when test="${result.getFieldError('username')!=null}">
        						<form:input path="username" type="text" class="form-control form-control is-invalid"/>
        					</c:when>
        					<c:otherwise>
                	...
                	<div class="form-group">
                    	...
                    	<c:choose>
        					<c:when test="${result.getFieldError('password')!=null}">
        						<form:input path="password" type="password" class="form-control form-control is-invalid"/>
        					</c:when>
        					<c:otherwise>
                	...
                	<div class="form-group">
                    	...
                    	<c:choose>
        					<c:when test="${result.getFieldError('confirmPassword')!=null}">
        						<form:input path="confirmPassword" type="password" class="form-control form-control is-invalid"/>
        					</c:when>
        					<c:otherwise>
